...
GOOGLE_API_KEY = "AIzaSyDS3Tjvmp89Y9hhTT5MW9GMRiRX0VEEEno"
...
S3_BUCKET = "cloud-assignment-kkak0805"
S3_REGION = "us-east-1"
...
def upload_image():
    ...
    if request.method == "POST":
        ...
        try:
            ...
            if connection is None:
                return render_template(
                    "upload.html",
                    error="Database Error: Unable to connect to the database.",
                )
        ...
        return render_template(
            "upload.html", image_data=encoded_image, file_url=file_url, caption=caption
        )
...
def gallery():
    ...
    try:
        ...
        cursor.execute(
            "SELECT image_key, caption FROM captions ORDER BY uploaded_at DESC"
        )
